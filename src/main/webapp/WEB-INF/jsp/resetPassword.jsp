...
<script type="text/javascript">
	Ext.onReady(function() {
		...
		MyApp.event.App.on({
			created : function() {
				...
				var explainHtml;
				if (invalidLink) {
					explainHtml = '<div style="font-size:x-large;font-weight:bold;">' + Locale.getMsg('view.auth.recoverAccount.resetPassword.invalidLink')
							+ '</div><div style="color:#FF0000;">' + Locale.getMsg('view.auth.recoverAccount.resetPassword.invalidLink.explain', '5')
							+ '</div>';

					setTimeout("window.location = './recoverAccount';", 5000);
				} else {
					explainHtml = '<div style="font-size:x-large;font-weight:bold;">' + Locale.getMsg('view.auth.recoverAccount.resetPassword') + '</div><div>'
	...
	// 					url : 'resetPassword',
	// 					success : function(form, action) {
	// 						win.down('#message').setMessage(true, Locale.getMsg('view.auth.recoverAccount.resetPassword.success'));
	// 					},
	// 					failure : function(form, action) {
	// 						if (form.isDirty()) {
	// 							win.down('#submit').setDisabled(false);
