...
<script type="text/javascript">
	Ext
			.onReady(function() {
				console.log('isOP=', Ecfa.Auth.isOP());
				if (Ecfa.Auth.isOP() === false) {
					var resendLink = '<a href="./resendActivateLink">'
							+ Locale.getMsg('view.auth.resendLink') + '</a>';
					var recoverAccount = '<a href="./recoverAccount">'
							+ Locale
									.getMsg('view.auth.recoverAccount.forgetPassword')
							+ '</a>';
					var recoverId = '<a href="./recoverId">'
							+ Locale.getMsg('view.auth.recoverId.forgetUserId')
							+ '</a>';
				}
							...
							created : function() {
								var submitOptions = {
									...
									success : function(form, action) {
										...
										Ext.util.Cookies.set('pauseAlert',
												false);
										var pauseAlert = Ext.util.Cookies
												.get('pauseAlert');
													...
													items : [
															{
																...
																items : [
																		...
																		{
																			// 											hidden : !Ecfa.Auth.isOP(),
																			xtype : 'component',
																			padding : '0 10 5 20',
																			html : '<div style="font-size:large;font-weight:bold;">'
																					+ ((Ecfa.Auth
																							.isOP()) ? Locale
																							.getMsg('view.welcomeOP')
																							: Locale
																									.getMsg('view.welcomeUP'))
																					+ '</div>',
																		},
																		Ext
																				.create(
															...
															// 							},
															{
																...
																setError : function(
																	...
																	me
																			.update(Locale
																					.getMsg('view.session.signin.failure.'
																							+ error));
																	win
																			.down(
																					'#submit')
