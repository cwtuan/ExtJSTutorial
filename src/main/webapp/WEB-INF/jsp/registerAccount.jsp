				...
				var submitOptions = {
					...
					//	console.log('emailProvider', emailProvider, emailProvider === 'gmail.com');
						if (emailProvider === 'gmail.com') {
							win.down('#message').setMessage(true, Locale.getMsg('view.auth.register.mailSent.gmail')+Locale.getMsg('view.auth.register.mailSent', win.down('#email').getValue()));
					//			setTimeout("window.location = 'http://www.gmail.com';", 3000);
						} else {
							win.down('#message').setMessage(true, Locale.getMsg('view.auth.recoverAccount.mailSent', win.down('#email').getValue(), '3'));
				...
				var win = Ext.create('widget.window', {
					...
					items : [ {
						...
						items : [ {
							...
							xtype : 'component',
							html : '<div style="font-size:x-large;font-weight:bold;">' + Locale.getMsg('view.auth.account.create') + '</div>',
							padding : '0 20 5 20'
						}, {
							itemId : 'id',
