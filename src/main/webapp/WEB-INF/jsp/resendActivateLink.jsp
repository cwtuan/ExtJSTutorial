			...
			created : function() {
				var submitOptions = {
					...
					success : function(form, action) {
						...
						win.down('#message').setMessage(true, Locale.getMsg('view.auth.user.resendLink.success.msg', action.result.target, '3'));
					...
					items : [
							{
								...
								items : [
										...
										{
											xtype : 'component',
											html : '<div style="font-size:x-large;font-weight:bold;">' + Locale.getMsg('view.auth.user.resendLink')
													+ '</div><div>' + Locale.getMsg('view.auth.user.resendLink.msg') + '</div>',
											padding : '5 20 5 20'
										}, {
											itemId : 'userId',
