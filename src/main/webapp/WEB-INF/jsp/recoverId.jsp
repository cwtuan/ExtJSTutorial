			...
			created : function() {
				var submitOptions = {
					...
					success : function(form, action) {
						...
						win.down('#message').setMessage(true, Locale.getMsg('view.auth.recoverAccount.mailSent', action.result.target, '3'));
					...
					items : [
							{
								...
								items : [
										...
										{
											xtype : 'component',
											html : '<div style="font-size:x-large;font-weight:bold;">' + Locale.getMsg('view.auth.recoverId') + '</div><div>'
