...
Ext.define('Ext.ux.IFrame', {
	...
	initEvents : function() {
		var me = this, iframeEl = me.iframeEl.dom, frameEl = me.getFrame();
		me.callParent();
	...
	onLoad : function() {
		/*
		 * if(this.src!='about:blank'){ console.log('on Load!! been fire!'); }
		 */

		var me = this, doc = me.getDoc(), fn = me.onRelayedEvent;

		if (doc && me.src != 'about:blank') { // alter
			try {
				Ext.EventManager.removeAll(doc);
			...
			Ext.getCmp('notifybar').showError(Locale.getMsg('err.internal'));
	...
	onRelayedEvent : function(event) {
		...
		var iframeEl = this.iframeEl, iframeXY = iframeEl.getXY(), eventXY = event.getXY();
